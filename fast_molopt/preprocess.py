...
def convert(train_path, pool, num_splits, output_path):
    ...
    all_data = [data for data in all_data if data != None]
...
if __name__ == "__main__":
    ...
    parser.add_option("-n", "--split", dest="nsplits", default=15)
    parser.add_option("-j", "--jobs", dest="njobs", default=32)
    ...
    convert(opts.train_path, pool, opts.nsplits, opts.output_path)